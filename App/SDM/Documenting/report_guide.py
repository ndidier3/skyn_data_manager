...
class ReportGuide:
    def __init__(self):
        ...
        self._curve_feature_descriptions = {
            ...
            # Jump features
            'jump_duration': 'Duration of jump data (hours)',
            'jump_percent': 'Percentage of jump data',
            'imputed_jump_duration': 'Duration of imputed jump data (hours)',
            'imputed_jump_percent': 'Percentage of imputed jump data',
            'unimputed_jump_duration': 'Duration of unimputed jump data (hours)',
            'unimputed_jump_percent': 'Percentage of unimputed jump data',
            'total_jump_duration': 'Total duration of jump data (hours)',
            'total_jump_percent': 'Total percentage of jump data',
            
            # Plummet features
            'plummet_duration': 'Duration of plummet data (hours)',
            'plummet_percent': 'Percentage of plummet data',
            ...
            'extreme_negative_duration': 'Duration of extreme negative data (hours)',
            'extreme_negative_percent': 'Percentage of extreme negative data',
            ...
            # Gap features
            'gap_duration': 'Duration of gap data (hours)',
            'gap_percent': 'Percentage of gap data',
            ...
            # Non-wear features
            'non_wear_duration': 'Duration of non-wear data (hours)',
            'non_wear_percent': 'Percentage of non-wear data',
            ...
            'unimputed_low_quality_percent': 'Percentage of unimputed low quality data',
            ...
            'jump_imputation_ratio': 'Ratio of jump data that has been imputed (0-1)',
            ...
            'negative_duration_PERIPHERY': 'Duration of negative TAC values in periphery (hours)',
            'sub_negative_10_duration_PERIPHERY': 'Duration of TAC values below -10 in periphery (hours)',
            'sub_negative_10_percent_PERIPHERY': 'Percentage of TAC values below -10 in periphery',
            # 'sub_negative_10_sum_PERIPHERY': 'Sum of all TAC values below -10 in periphery',
            'sub_negative_20_duration_PERIPHERY': 'Duration of TAC values below -20 in periphery (hours)',
            'sub_negative_20_percent_PERIPHERY': 'Percentage of TAC values below -20 in periphery',
            'consecutive_sub_negative_40_duration_PERIPHERY': 'Longest consecutive duration of TAC values below -40 in periphery (hours)',
            'jump_duration_PERIPHERY': 'Duration of jump-imputed data in periphery (hours)',
            'jump_percent_PERIPHERY': 'Percentage of jump-imputed data in periphery',
            'plummet_duration_PERIPHERY': 'Duration of plummet-imputed data in periphery (hours)',
            'plummet_percent_PERIPHERY': 'Percentage of plummet-imputed data in periphery',
            ...
            'consecutive_non_wear_duration_REGION': 'Longest consecutive duration of non-wear in region (hours)',
            'consecutive_non_wear_percent_REGION': 'Percentage of consecutive non-wear in region',
            ...
            'jump_duration_REGION': 'Duration of jump-imputed data in region (hours)',
            'jump_percent_REGION': 'Percentage of jump-imputed data in region',
            'plummet_duration_REGION': 'Duration of plummet-imputed data in region (hours)',
            'plummet_percent_REGION': 'Percentage of plummet-imputed data in region',
            ...
            'low_quality_duration_REGION': 'Duration of low quality data in region (hours)',
            'low_quality_percent_REGION': 'Percentage of low quality data in region',
            ...
            'sub_negative_10_duration_REGION': 'Duration of TAC values below -10 in region (hours)',
            'sub_negative_10_percent_REGION': 'Percentage of TAC values below -10 in region',
        ...
        self._person_level_feature_types = {
            ...
            'consecutive_non_wear_duration_REGION': 'numeric',
            'consecutive_non_wear_percent_REGION': 'numeric',
            'flatline_max_REGION': 'numeric',
            'flatlined_percent_REGION': 'numeric',
            'jump_duration_REGION': 'numeric',
            'jump_percent_REGION': 'numeric',
            'plummet_duration_REGION': 'numeric',
            'plummet_percent_REGION': 'numeric',
            'imputed_duration_REGION': 'numeric',
            'imputed_percent_REGION': 'numeric',
            'low_quality_duration_REGION': 'numeric',
            'low_quality_percent_REGION': 'numeric',
            'unimputed_low_quality_duration_REGION': 'numeric',
            'unimputed_low_quality_percent_REGION': 'numeric',
            'sub_negative_10_duration_REGION': 'numeric',
            'sub_negative_10_percent_REGION': 'numeric',
