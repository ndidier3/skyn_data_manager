...
definitions = [
  ...
  'Using 28 Celcius TEMP CUTOFF: 1 = Device Worn (and device turned on) | 0 = Device NOT Worn (while device was on) | blank/null value (device was turned off)',
  'Using TRAINED MODEL (when possible): 1 = Device Worn (and device turned on) | 0 = Device NOT Worn (while device was on) | blank/null value (device was turned off)',
