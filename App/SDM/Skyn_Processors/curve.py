...
class Curve:
  def __init__(self, df: pd.DataFrame, subid, dataset_identifier, curve_id, curve_start, curve_end, curve_count, curve_threshold, flag_selections = {}, periphery_buffer_before = 2, periphery_buffer_after = 2, TAC_column = 'TAC'):
    ...
    self.curve_quality_features = {
      ...
      'unimputed_gap_duration_CURVE': self.curve_quality_analyzer.get_unimputed_gap_duration() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_gap_duration(),
      'unimputed_gap_percent_CURVE': self.curve_quality_analyzer.get_unimputed_gap_percent() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_gap_percent(),
      ...
      'unimputed_non_wear_duration_CURVE': self.curve_quality_analyzer.get_unimputed_non_wear_duration() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_non_wear_duration(),
      'unimputed_non_wear_percent_CURVE': self.curve_quality_analyzer.get_unimputed_non_wear_percent() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_non_wear_percent(),
      ...
      'unimputed_jump_duration_CURVE': self.curve_quality_analyzer.get_unimputed_jump_duration() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_jump_duration(),
      'unimputed_jump_percent_CURVE': self.curve_quality_analyzer.get_unimputed_jump_percent() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_jump_percent(),
      ...
      'unimputed_plummet_duration_CURVE': self.curve_quality_analyzer.get_unimputed_plummet_duration() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_plummet_duration(),
      'unimputed_plummet_percent_CURVE': self.curve_quality_analyzer.get_unimputed_plummet_percent() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_plummet_percent(),
      ...
      'unimputed_extreme_negative_duration_CURVE': self.curve_quality_analyzer.get_unimputed_extreme_negative_duration() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_extreme_negative_duration(),
      'unimputed_extreme_negative_percent_CURVE': self.curve_quality_analyzer.get_unimputed_extreme_negative_percent() if self.TAC_column != 'TAC_pre_imputation' else self.curve_quality_analyzer.get_total_extreme_negative_percent(),
    ...
    self.periphery_before_quality_features = {
      ...
      'unimputed_gap_duration_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_gap_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_gap_duration(),
      'unimputed_gap_percent_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_gap_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_gap_percent(),
      ...
      'unimputed_non_wear_duration_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_non_wear_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_non_wear_duration(),
      'unimputed_non_wear_percent_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_non_wear_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_non_wear_percent(),
      ...
      'unimputed_jump_duration_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_jump_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_jump_duration(),
      'unimputed_jump_percent_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_jump_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_jump_percent(),
      ...
      'unimputed_plummet_duration_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_plummet_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_plummet_duration(),
      'unimputed_plummet_percent_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_plummet_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_plummet_percent(),
      ...
      'unimputed_extreme_negative_duration_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_extreme_negative_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_extreme_negative_duration(),
      'unimputed_extreme_negative_percent_PERIPHERY_BEFORE': self.periphery_before_quality_analyzer.get_unimputed_extreme_negative_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_before_quality_analyzer.get_total_extreme_negative_percent(),
    ...
    self.periphery_after_quality_features = {
      ...
      'unimputed_gap_duration_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_gap_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_gap_duration(),
      'unimputed_gap_percent_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_gap_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_gap_percent(),
      ...
      'unimputed_non_wear_duration_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_non_wear_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_non_wear_duration(),
      'unimputed_non_wear_percent_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_non_wear_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_non_wear_percent(),
      ...
      'unimputed_jump_duration_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_jump_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_jump_duration(),
      'unimputed_jump_percent_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_jump_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_jump_percent(),
      ...
      'unimputed_plummet_duration_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_plummet_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_plummet_duration(),
      'unimputed_plummet_percent_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_plummet_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_plummet_percent(),
      ...
      'unimputed_extreme_negative_duration_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_extreme_negative_duration() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_extreme_negative_duration(),
      'unimputed_extreme_negative_percent_PERIPHERY_AFTER': self.periphery_after_quality_analyzer.get_unimputed_extreme_negative_percent() if self.TAC_column != 'TAC_pre_imputation' else self.periphery_after_quality_analyzer.get_total_extreme_negative_percent(),
    ...
    self.region_quality_features = {
      ...
      'unimputed_gap_duration_REGION': self.region_quality_analyzer.get_unimputed_gap_duration() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_gap_duration(),
      'unimputed_gap_percent_REGION': self.region_quality_analyzer.get_unimputed_gap_percent() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_gap_percent(),
      ...
      'unimputed_non_wear_duration_REGION': self.region_quality_analyzer.get_unimputed_non_wear_duration() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_non_wear_duration(),
      'unimputed_non_wear_percent_REGION': self.region_quality_analyzer.get_unimputed_non_wear_percent() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_non_wear_percent(),
      ...
      'unimputed_jump_duration_REGION': self.region_quality_analyzer.get_unimputed_jump_duration() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_jump_duration(),
      'unimputed_jump_percent_REGION': self.region_quality_analyzer.get_unimputed_jump_percent() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_jump_percent(),
      ...
      'unimputed_plummet_duration_REGION': self.region_quality_analyzer.get_unimputed_plummet_duration() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_plummet_duration(),
      'unimputed_plummet_percent_REGION': self.region_quality_analyzer.get_unimputed_plummet_percent() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_plummet_percent(),
      ...
      'unimputed_extreme_negative_duration_REGION': self.region_quality_analyzer.get_unimputed_extreme_negative_duration() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_extreme_negative_duration(),
      'unimputed_extreme_negative_percent_REGION': self.region_quality_analyzer.get_unimputed_extreme_negative_percent() if self.TAC_column != 'TAC_pre_imputation' else self.region_quality_analyzer.get_total_extreme_negative_percent(),
